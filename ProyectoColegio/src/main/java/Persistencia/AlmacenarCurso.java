 ...
 * @author cr075
 */
public class AlmacenarCurso {
   
    public static String ARCHIVO="DatosRegistroCurso.bin";
    public static void GuardarCurso(ListaEnlazadaSimpleCurso lista){
        try{
    ...
    public static ListaEnlazadaSimpleCurso recuperarCurso(){
         ListaEnlazadaSimpleCurso Lista=new ListaEnlazadaSimpleCurso();
          try{
           ...
           Lista=(ListaEnlazadaSimpleCurso) oi.readObject(); //en lista se recupera los objetos
