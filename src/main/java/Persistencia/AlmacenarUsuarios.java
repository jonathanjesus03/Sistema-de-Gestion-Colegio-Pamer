...
public class AlmacenarUsuarios {
    ...
    public static String ARCHIVO="DatosRegistroUsuarios.bin";
    public static void GuardarUsuarios(ArrayListUsers lista){
        try{
    ...
    public static ArrayListUsers recuperarUsuarios(){
          ArrayListUsers Lista=new ArrayListUsers();
          try{
           ...
           Lista=(ArrayListUsers) oi.readObject(); //en lista se recupera los objetos
