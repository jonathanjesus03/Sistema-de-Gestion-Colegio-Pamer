...
public class AlmacenarHorario {
    ...
    public static String ARCHIVO="DatosRegistroHorario.bin";
    public static void GuardarHorario(PilaHorario pila){
        try{
    ...
    public static PilaHorario recuperarHorario(){
         PilaHorario Lista=new PilaHorario();
          try{
           ...
           Lista=(PilaHorario) oi.readObject(); //en lista se recupera los objetos
